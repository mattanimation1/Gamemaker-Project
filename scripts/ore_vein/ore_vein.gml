...
{
	if !place_meeting(i+veinOffsetX,b+veinOffsetY,oUnderGroundLightSquare) {
		...
		var VeinY=choose(0,0,0,-1,1,1,1)
		veinOffsetX += VeinX * 32
		veinOffsetY += VeinY * 32
		instance_create_depth(i+veinOffsetX,b+veinOffsetY,0, oUnderGroundLightSquare)
	}
}