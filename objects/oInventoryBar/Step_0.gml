if oGame.draw == true || var_slot < 9 {
	...
	var amount = global.mouse_slot[# 0, 1];
	 ...
	 if mouse_check_button_pressed(mb_left) && mouseOver(camera_get_view_x(view_camera[0])+xOrigin,camera_get_view_y(view_camera[0])+yOrigin, 64,64) && var_slot != 4 &&  mouseOver(camera_get_view_x(view_camera[0])+xOrigin,(camera_get_view_y(view_camera[0])+200)+64*floor(var_slot/9),64,64)  {
	 ...
	 } else if mouseOver(camera_get_view_x(view_camera[0])+xOrigin,(camera_get_view_y(view_camera[0])+200)+64*floor(var_slot/9),64,64) &&  mouse_check_button_pressed(mb_left) && oGame.draw == true && var_slot != 4 {
